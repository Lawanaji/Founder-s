  ...
  return (
    <div style={{backgroundPosition: "80%"}} className="min-h-[500px] grid grid-cols-1 md:grid-cols-2 justify-center items-start gap-10 md:gap-0 md:bg-[url('/src/assets/img/line.svg')] bg-no-repeat bg-contain py-14 px-[5%] -mt-4">
      <div className="z-10">
        ...
        <button className="flex justify-center items-center border-primaryColor border px-6 py-3 rounded-3xl text-sm md:text-base mt-4 transition duration-300">Register For Our Next Event
          <img src={buttonArrow} alt="" className='w-10'/>
        </button>
        <p className="text-sm md:text-base text-gray-600">Join Us for our next meetup on the 26th of July 2024</p>
